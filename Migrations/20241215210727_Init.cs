...
namespace api_do_an_cnpm.Migrations
{
    /// <inheritdoc />
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AcceptableVehicles = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Facilities_Houses_HouseId",
                        column: x => x.HouseId,
                        principalTable: "Houses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "505faa31-ba3e-4982-bfae-308614b4da33", null, null, "OwnerHouse", "OWNERHOUSE" },
                    { "505faa31-ba3e-4982-bfae-308614b4da92", null, null, "Admin", "ADMIN" },
                    { "5e32977f-1f8d-4429-bbf7-518bdcae5bef", null, null, "Student", "STUDENT" }
                });
